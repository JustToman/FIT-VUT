...
*/
	...
	// setting f_index and b_index to 0  (queue is empty)
	q->f_index = 0;
	q->b_index = 0;


	//Filling queue array with zeros
...
*/
	  //if b_index == f_index queue is empty
...
*/
	...
	//setting f_index to nextIndex of f_index
...
*/
	...
	//Setting b_index to nextIndex of b_index
