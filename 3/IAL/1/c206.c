...
**/
    ...
    while(element != NULL)
    {
        tDLElemPtr next_element = element->rptr;
        free(element);
...
**/
    ...
    {
        tDLElemPtr element_to_delete = L->Act->rptr;

        L->Act->rptr = element_to_delete->rptr;
        if (element_to_delete->rptr != NULL)
            element_to_delete->rptr->lptr = L->Act;
        
        if(element_to_delete == L->Last)
            L->Last = L->Act;
...
**/
    ...
    {
        tDLElemPtr element_to_delete = L->Act->lptr;

        L->Act->lptr = element_to_delete->lptr;

        if (element_to_delete->lptr != NULL)
            element_to_delete->lptr->rptr = L->Act;
        
        if(element_to_delete == L->First)
            L->First = L->Act;
