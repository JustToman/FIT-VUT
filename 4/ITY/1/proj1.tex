...
\href{mailto:xpopel24@stud.fit.vutbr.cz}{xpopel24@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
    ...
    písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\fontfamily{pzc}\selectfont {\Large dokument}} vypadat. 
...
\begin{itemize}
    ...
    \footnote{Příliš mnoho poznámek pod čarou čtenáře zbytečně rozptyluje.} používejte opravdu střídmě.
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \textit{vlna} od pana Olšáka%
\footnote{Viz \url{http://petr.olsak.net/ftp/olsak/vlna/}}.
